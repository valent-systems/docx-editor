...
function main() {
  ...
  //  - deferredInVue: explicit on React, intentionally absent from Vue (mirror of
  //    props.deferredInVue — a React-adapter member with no Vue equivalent yet)
