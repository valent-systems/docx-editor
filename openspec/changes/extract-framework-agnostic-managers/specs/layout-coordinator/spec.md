...
The `LayoutCoordinator` class SHALL import only from `@valent/docx-editor-core` internals and vanilla DOM APIs. It SHALL NOT import React, Vue, or any framework.
