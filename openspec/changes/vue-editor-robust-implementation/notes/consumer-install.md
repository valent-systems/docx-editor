...
- `@sqren/docx-editor-vue@0.0.1`
- `@sqren/docx-editor-core@0.0.28`
- `@sqren/docx-editor-agents@0.5.1`
- `@sqren/docx-editor-i18n@0.0.1`
...
pack-only check cannot fetch `@sqren/docx-editor-core` from the public
...
`@sqren/docx-editor-vue/styles.css`, mounted the component with
