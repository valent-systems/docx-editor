...
Separate package (`@valent/docx-editor-agents`) under BSL-1.1 — source-available, free for non-production, paid subscription for commercial use.

## What Changes

- **New package** `packages/agent-use/` → `@valent/docx-editor-agents` (BSL-1.1)
...
- **Peer dependency**: `@valent/docx-editor-core` — no code duplication
