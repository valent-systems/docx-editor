...
This creates `packages/i18n/<lang>.json` with all keys set to `null`, mirroring the structure of `en.json`. Use a [BCP 47](https://en.wikipedia.org/wiki/IETF_language_tag) language tag.
...
```tsx
import pl from '@eigenpal/docx-editor-i18n/pl.json';
