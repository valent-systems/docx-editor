...
| Entry point  | `@sqren/docx-editor-react/plugin-api`                      | `@sqren/docx-editor-core/core-plugins`                 |
...
import { PluginHost } from '@sqren/docx-editor-react/plugin-api';
...
```ts
import type { EditorPlugin } from '@sqren/docx-editor-react/plugin-api';
