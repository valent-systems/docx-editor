...
```
@sqren/docx-editor-core/headless   → Headless API (Node.js, no DOM needed)
```
...
```ts
import { DocumentAgent, parseDocx, processTemplate } from '@sqren/docx-editor-core/headless';
```
...
```ts
import { DocumentAgent } from '@sqren/docx-editor-core/headless';
import fs from 'fs';
...
import { processTemplate } from '@sqren/docx-editor-core/headless';
...
```ts
import type { Document } from '@sqren/docx-editor-core';
import type { CorePlugin, PluginCommand } from '@sqren/docx-editor-core/core-plugins';
...
```ts
import { pluginRegistry } from '@sqren/docx-editor-core/core-plugins';
...
// Batch registration
import { registerPlugins } from '@sqren/docx-editor-core/core-plugins';
...
```ts
import { pluginRegistry, docxtemplaterPlugin } from '@sqren/docx-editor-core/core-plugins';
