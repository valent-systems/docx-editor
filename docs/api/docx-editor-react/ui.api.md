## API Report File for "@valent/docx-editor-react"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { AgentResponse } from '@valent/docx-editor-core/types/agentApi';
import { AIAction } from '@valent/docx-editor-core/types/agentApi';
import { ColorValue } from '@valent/docx-editor-core/types/document';
import { createDefaultFindOptions } from '@valent/docx-editor-core/utils/findReplace';
import { createDefaultListState } from '@valent/docx-editor-core/utils/listState';
import { createSearchPattern } from '@valent/docx-editor-core/utils/findReplace';
import { CSSProperties } from 'react';
import { Document as Document_2 } from '@valent/docx-editor-core/types/document';
import { escapeRegexString } from '@valent/docx-editor-core/utils/findReplace';
import { findAllMatches } from '@valent/docx-editor-core/utils/findReplace';
import { findInDocument } from '@valent/docx-editor-core/utils/findReplace';
import { findInParagraph } from '@valent/docx-editor-core/utils/findReplace';
import { FindMatch } from '@valent/docx-editor-core/utils/findReplace';
import { FindOptions } from '@valent/docx-editor-core/utils/findReplace';
import { FindResult } from '@valent/docx-editor-core/utils/findReplace';
import { FontOption } from '@valent/docx-editor-core/utils/fontOptions';
import { formatPageRange as formatPrintPageRange } from '@valent/docx-editor-core';
import { getDefaultHighlightOptions } from '@valent/docx-editor-core/utils/findReplace';
import { getDefaultPrintOptions } from '@valent/docx-editor-core';
import { getMatchCountText } from '@valent/docx-editor-core/utils/findReplace';
import { HighlightOptions } from '@valent/docx-editor-core/utils/findReplace';
import { isEmptySearch } from '@valent/docx-editor-core/utils/findReplace';
import { isPrintSupported } from '@valent/docx-editor-core';
import { ListState } from '@valent/docx-editor-core/utils/listState';
import { openPrintWindow } from '@valent/docx-editor-core';
import { ParagraphAlignment } from '@valent/docx-editor-core/types/document';
import { ParsedClipboardContent } from '@valent/docx-editor-core/utils';
import { parsePageRange } from '@valent/docx-editor-core';
import { PrintOptions } from '@valent/docx-editor-core';
import * as React$1 from 'react';
import React__default from 'react';
import { ReactNode } from 'react';
import { replaceAllInContent } from '@valent/docx-editor-core/utils/findReplace';
import { replaceFirstInContent } from '@valent/docx-editor-core/utils/findReplace';
import { scrollToMatch } from '@valent/docx-editor-core/utils/findReplace';
import { SectionProperties } from '@valent/docx-editor-core/types/document';
import { SelectionContext } from '@valent/docx-editor-core/types/agentApi';
import { Style } from '@valent/docx-editor-core/types/document';
import { StyleType } from '@valent/docx-editor-core/types/document';
import { Table } from '@valent/docx-editor-core/types/document';
import { TableCell } from '@valent/docx-editor-core/types/document';
import { TabStop } from '@valent/docx-editor-core/types/document';
import { Theme } from '@valent/docx-editor-core/types/document';
import { TranslationKey } from '@valent/docx-editor-i18n';
import { triggerPrint } from '@valent/docx-editor-core';
