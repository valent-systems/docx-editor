...
```bash
npm install @valent/docx-editor-react @valent/docx-editor-agents ai @ai-sdk/react @ai-sdk/openai
```
...
- [Tool catalog](/docs/1.x/agents/tools): every tool with parameters
