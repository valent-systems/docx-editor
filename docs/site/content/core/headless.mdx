---
title: 'Headless API'
description: 'Reference for @sqren/docx-editor-core/headless: DOCX parse and serialize, document creation, content controls, templates, watermarks, DocumentAgent.'
category: 'Core'
---
...
```ts
import { parseDocx, repackDocx } from "@sqren/docx-editor-core/headless";
...
```ts
import { getParagraphs, getParagraphText } from "@sqren/docx-editor-core/headless";
