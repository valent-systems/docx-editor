...
```ts
import { setContentControlContent, removeContentControl } from "@sqren/docx-editor-core/headless";
...
```ts
import { setContentControlValue } from "@sqren/docx-editor-core/headless";
...
```ts
import { addRepeatingSectionItem, removeRepeatingSectionItem } from "@sqren/docx-editor-core/headless";
