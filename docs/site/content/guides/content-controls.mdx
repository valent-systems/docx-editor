...
```ts
import { setContentControlContent, removeContentControl } from "@valent/docx-editor-core/headless";
...
```ts
import { setContentControlValue } from "@valent/docx-editor-core/headless";
...
```ts
import { createContentControl } from "@valent/docx-editor-core/headless";
...
```ts
import { addRepeatingSectionItem, removeRepeatingSectionItem } from "@valent/docx-editor-core/headless";
