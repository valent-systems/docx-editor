...
For localStorage autosave with crash recovery, use the `useAutoSave` composable from `@sqren/docx-editor-vue/composables` instead.
...
<template>
  <div class="layout">
    ...
    <!-- your chat pane: AgentChatLog / AgentComposer from
         @sqren/docx-editor-agents/vue, or your own UI -->
  </div>
</template>
```
