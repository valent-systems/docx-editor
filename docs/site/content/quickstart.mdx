---
title: 'Quickstart'
description: 'Load, edit, and save a .docx in the browser. Copy-paste setup for the React and Vue adapters.'
...
Either adapter pulls in `@valent/docx-editor-core` and `@valent/docx-editor-i18n` transitively. One install is enough.
...
- [Installation](/docs/1.x/installation) for Next.js, Remix, Astro, and Nuxt specifics
