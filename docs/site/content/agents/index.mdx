---
title: 'Overview'
description: 'Let a model read and edit DOCX: comments, tracked changes, redlining. Run against a live editor, headless in Node, or over MCP.'
category: 'Agents'
order: 50
seoTitle: 'AI agents for DOCX editing'
---

<PackageStats name="@valent/docx-editor-agents" />
...
import { createReviewerBridge } from '@valent/docx-editor-agents';
...
| Subpath                        | Use when                                                                                  |
| ------------------------------ | ----------------------------------------------------------------------------------------- |
| `@valent/docx-editor-agents` | `DocxReviewer`, `agentTools`, `getToolSchemas`, `executeToolCall`, `createReviewerBridge` |
