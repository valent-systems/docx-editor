...
<PackageStats name="@sqren/docx-editor-agents" />
...
```ts
import { McpServer } from '@sqren/docx-editor-agents/mcp';
import { createReviewerBridge } from '@sqren/docx-editor-agents';
...
| Subpath                        | Use when                                                                                  |
| ------------------------------ | ----------------------------------------------------------------------------------------- |
| `@sqren/docx-editor-agents` | `DocxReviewer`, `agentTools`, `getToolSchemas`, `executeToolCall`, `createReviewerBridge` |
