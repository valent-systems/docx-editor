...
import { TextSelection } from '@sqren/docx-editor-core/prosemirror';
import {
  acceptChangeById,
  rejectChangeById,
  acceptAllChanges,
...
import { loadFont } from '@sqren/docx-editor-core/utils';
...
export function App() {
  ...
  // `loadFont(name)` from `@sqren/docx-editor-core/utils` directly.
