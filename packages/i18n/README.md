...
<p align="center">
  <a href="https://www.npmjs.com/package/@sqren/docx-editor-i18n"><img src="https://img.shields.io/npm/v/@sqren/docx-editor-i18n.svg?style=flat-square&color=3B5BDB" alt="npm version" /></a>
  <a href="https://www.npmjs.com/package/@sqren/docx-editor-i18n"><img src="https://img.shields.io/npm/dm/@sqren/docx-editor-i18n.svg?style=flat-square&color=3B5BDB" alt="npm downloads" /></a>
...
Shared locale strings, types, and runtime helpers for the [docx-editor](https://docx-editor.dev) adapters. One source of truth for translations consumed by `@sqren/docx-editor-react` and `@sqren/docx-editor-vue`.

## Quick Start

```bash
npm install @sqren/docx-editor-i18n
```
...
```tsx
// React
import { de } from '@sqren/docx-editor-i18n';
...
```ts
import { locales } from '@sqren/docx-editor-i18n';
...
Subpaths ship for every locale: `/en`, `/de`, `/he`, `/pl`, `/pt-BR`, `/tr`, `/zh-CN`. Each also exports its locale as a named binding (`import { pl } from '@sqren/docx-editor-i18n/pl'`) for callers that prefer non-default imports.
...
```ts
import { createT, deepMerge, en, de, type LocaleStrings } from '@sqren/docx-editor-i18n';
