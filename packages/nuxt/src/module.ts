 ...
 *
 * Nuxt module that wraps the `@valent/docx-editor-vue` adapter so Nuxt apps
...
const COMPOSABLES_SUBPATH = '@valent/docx-editor-vue/composables';
const STYLES_SUBPATH = '@valent/docx-editor-vue/styles.css';

// Public composables re-exported by `@valent/docx-editor-vue/composables`.
...
export interface ModuleOptions {
   ...
   * Set to `false` to import `@valent/docx-editor-vue/styles.css` yourself.
   * Defaults to `true`.
   */
