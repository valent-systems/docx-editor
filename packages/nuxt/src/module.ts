 ...
 *
 * Nuxt module that wraps the `@sqren/docx-editor-vue` adapter so Nuxt apps
...
const COMPOSABLES_SUBPATH = '@sqren/docx-editor-vue/composables';
const STYLES_SUBPATH = '@sqren/docx-editor-vue/styles.css';

// Public composables re-exported by `@sqren/docx-editor-vue/composables`.
...
export interface ModuleOptions {
   ...
   * Set to `false` to import `@sqren/docx-editor-vue/styles.css` yourself.
   * Defaults to `true`.
   */
