 ...
 * @example
 * ```ts
 * import { acceptChange } from '@valent/docx-editor-core/prosemirror/commands';
 ...
 * @example
 * ```ts
 * import { acceptAllChanges } from '@valent/docx-editor-core/prosemirror/commands';
 ...
 * @example
 * ```ts
 * import { acceptChangeById } from '@valent/docx-editor-core/prosemirror/commands';
