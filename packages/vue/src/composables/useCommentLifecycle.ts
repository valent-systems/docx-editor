...
import { extractTrackedChanges } from '@sqren/docx-editor-core/prosemirror/utils/extractTrackedChanges';
import { findElementAtPosition } from '../utils/domQueries';
import { createComment as createCommentCore } from '@sqren/docx-editor-core/prosemirror/commentOps';
import {
  seedCommentAllocator,
  PENDING_COMMENT_ID,
  type CommentIdAllocator,
} from '@sqren/docx-editor-core/prosemirror/commentIdAllocator';
