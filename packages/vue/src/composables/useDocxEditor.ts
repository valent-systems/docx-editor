...
import { parseDocx } from '@valent/docx-editor-core/docx/parser';
import {
...
import {
  ...
  proseDocToBlocks,
} from '@valent/docx-editor-core/prosemirror/conversion';
import { fromProseDoc } from '@valent/docx-editor-core/prosemirror/conversion/fromProseDoc';
import { schema, ensureParaIdsInState } from '@valent/docx-editor-core/prosemirror';
import { singletonManager } from '@valent/docx-editor-core/prosemirror/schema';
import {
  createSuggestionModePlugin,
  setSuggestionMode,
  createDocumentStylesPlugin,
  createDocumentContextPlugin,
} from '@valent/docx-editor-core/prosemirror/plugins';
import {
  ExtensionManager,
  createStarterKit,
} from '@valent/docx-editor-core/prosemirror/extensions';
import type { CommandMap } from '@valent/docx-editor-core/prosemirror/extensions/types';
import {
  measureBlocksWithFloats,
  measureParagraph,
} from '@valent/docx-editor-core/layout-bridge/measuring';
import type {
  FloatingImageZone,
  FloatPageGeometry,
} from '@valent/docx-editor-core/layout-bridge/measuring';
...
import { renderPages } from '@valent/docx-editor-core/layout-painter/renderPage';
import type {
  FlowBlock,
  Layout,
  Measure,
  ...
  ImageBlock,
  TextBoxBlock,
} from '@valent/docx-editor-core/layout-engine/types';
import {
  buildBlockLookup,
...
// `@valent/docx-editor-core/layout-bridge` so React and Vue agree on
 ...
 *
 * `measureTableBlock` lives in `@valent/docx-editor-core/layout-bridge`
...
export interface UseDocxEditorReturn {
   ...
   */
  getHfPmView: (
    hf: import('@valent/docx-editor-core/types/document').HeaderFooter
  ) => EditorView | null;
...
export function useDocxEditor(options: UseDocxEditorOptions): UseDocxEditorReturn {
  ...
  async function save(): Promise<Blob | null> {
    ...
    const { repackDocx, createDocx } = await import('@valent/docx-editor-core/docx/rezip');
    const { injectReplyRangeMarkers, injectTCReplyRangeMarkers } =
      await import('@valent/docx-editor-core/docx');
