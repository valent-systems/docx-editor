...
import type { HeaderFooter, BlockContent } from '@sqren/docx-editor-core/types/content';
import type { Document, SectionProperties } from '@sqren/docx-editor-core/types/document';
import { findImageElement } from '@sqren/docx-editor-core/layout-painter';
import {
  detectTableInsertHover,
  TABLE_INSERT_HIDE_DELAY_MS,
} from '@sqren/docx-editor-core/layout-bridge/tableInsertHover';
import {
...
} from '@sqren/docx-editor-core/prosemirror/cellDragSelection';
...
export interface UsePagesPointerOptions {
  ...
  getHfPmView?: (
    hf: import('@sqren/docx-editor-core/types/content').HeaderFooter
