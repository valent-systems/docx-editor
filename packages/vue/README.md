...
<p align="center">
  <a href="https://www.npmjs.com/package/@valent/docx-editor-vue"><img src="https://img.shields.io/npm/v/@valent/docx-editor-vue.svg?style=flat-square&color=3B5BDB" alt="npm version" /></a>
  <a href="https://www.npmjs.com/package/@valent/docx-editor-vue"><img src="https://img.shields.io/npm/dm/@valent/docx-editor-vue.svg?style=flat-square&color=3B5BDB" alt="npm downloads" /></a>
...
> **Using Nuxt?** [`@valent/nuxt-docx-editor`](https://www.npmjs.com/package/@valent/nuxt-docx-editor) wraps this adapter as a Nuxt 3 & 4 module — SSR-safe component registration and the stylesheet are wired automatically.
...
<script setup lang="ts">
import { ref } from 'vue';
import { DocxEditor, createEmptyDocument } from '@valent/docx-editor-vue';
import '@valent/docx-editor-vue/styles.css';
...
| [`@valent/nuxt-docx-editor`](https://www.npmjs.com/package/@valent/nuxt-docx-editor)     | <img src="https://cdn.simpleicons.org/nuxt/00DC82" width="20" align="middle" /> &nbsp; Nuxt 3 & 4 module wrapping this adapter.            |
...
```ts
import { renderAsync } from '@valent/docx-editor-vue';
...
- `@valent/docx-editor-vue` — `DocxEditor`, `renderAsync`, public types
- `@valent/docx-editor-vue/ui` — toolbar primitives, pickers, sidebars, dialogs
- `@valent/docx-editor-vue/composables` — `useDocxEditor`, `useZoom`, `useTableSelection`, ...
- `@valent/docx-editor-vue/dialogs` — dialog SFCs barrel
- `@valent/docx-editor-vue/plugin-api` — plugin host and plugin-facing types
- `@valent/docx-editor-vue/styles` — style constants (`EDITOR_CSS_PATH`, z-index)
