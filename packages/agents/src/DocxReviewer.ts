import type { Document, DocumentBody } from '@sqren/docx-editor-core/headless';
import { parseDocx } from '@sqren/docx-editor-core/headless';
import type {
  ContentBlock,
  GetContentOptions,
  ReviewChange,
...
export class DocxReviewer {
  ...
  async toBuffer(): Promise<ArrayBuffer> {
    ...
    const { repackDocx } = await import('@sqren/docx-editor-core/headless');
