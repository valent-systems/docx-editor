/**
 * @valent/docx-editor-agents/bridge
 *
 * Editor bridge that connects agent tools to a live `DocxEditor` instance.
 * Framework-agnostic. The React adapter lives in
 * `@valent/docx-editor-agents/react`.
 *
 * @example
 * ```ts
 * import { createEditorBridge } from '@valent/docx-editor-agents/bridge';
...
} from '@valent/docx-editor-core/utils/paragraphFlashTypes';
...
function getDocumentBody(
...
): import('@valent/docx-editor-core/headless').DocumentBody | null {
  ...
  if (pagedRef) {
    const doc = pagedRef.getDocument() as
      | import('@valent/docx-editor-core/headless').Document
      | null;
