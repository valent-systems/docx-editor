...
import type { AIAction, SelectionContext } from '@sqren/docx-editor-core/types/agentApi';
import { getActionDescription, DEFAULT_AI_ACTIONS } from '@sqren/docx-editor-core/types/agentApi';
