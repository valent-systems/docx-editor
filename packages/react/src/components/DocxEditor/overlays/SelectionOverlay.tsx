...
import type { SelectionRect, CaretPosition } from '@valent/docx-editor-core/layout-bridge';
...
export function useSelectionOverlay(
  ...
  layout: import('@valent/docx-editor-core/layout-engine').Layout | null,
  blocks: import('@valent/docx-editor-core/layout-engine').FlowBlock[],
  measures: import('@valent/docx-editor-core/layout-engine').Measure[]
): {
  selectionRects: SelectionRect[];
  caretPosition: CaretPosition | null;
} {
  ...
  useEffect(() => {
    ...
    import('@valent/docx-editor-core/layout-bridge').then(
