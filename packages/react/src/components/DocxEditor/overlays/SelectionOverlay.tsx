...
import type { SelectionRect, CaretPosition } from '@sqren/docx-editor-core/layout-bridge';
...
export function useSelectionOverlay(
  ...
  layout: import('@sqren/docx-editor-core/layout-engine').Layout | null,
  blocks: import('@sqren/docx-editor-core/layout-engine').FlowBlock[],
  measures: import('@sqren/docx-editor-core/layout-engine').Measure[]
): {
  selectionRects: SelectionRect[];
  caretPosition: CaretPosition | null;
} {
  ...
  useEffect(() => {
    ...
    import('@sqren/docx-editor-core/layout-bridge').then(
